					...
					<tr>			
						...
						if (!empty($_SESSION['catalog'])){
							foreach($_SESSION['catalog'] as $brand => $massiv) {
								...
								echo "<td><a href='index.php?page=item&id=$brand'>".$massiv['name']."</a></td><td>".$massiv['autors']."</td><td>".$massiv['year']."</td><td>".$massiv['description']."</td>";
								echo "</tr>";
							}
						}
						?>
